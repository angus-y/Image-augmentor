...
def unrotate2d(pts):
    ...
    #edited in github code to prevent rotations of 180 degrees
    ...
    # return R.T #return the inverse (original)
    return R2d.T # edited to return the rotation constrained matrix
